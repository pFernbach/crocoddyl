...
# First double support stance:
init_ds_cop_target = np.array([0, 0])
init_ds_model_running = ActionModelCOP(init_ds_cop_target)
init_ds_model_terminal = ActionModelCOP(init_ds_cop_target, weight_state_regularization=1)


# Formulating the optimal control problem
T = 20  # number of knots
x0 = np.matrix([0.3, -0.2, 0, 0, 0, 0]).T
problem = crocoddyl.ShootingProblem(x0, [init_ds_model_running] * T, init_ds_model_terminal)
